...
docker run --rm -it \
    ...
    yangby0cryptape/ckb-build:bionic-rustc1.39.0 \
    ${COMMANDS}
```
...
Supported tags and respective `Dockerfile` links:
  - [`bionic-rustc1.39.0-riscv20190829`]
...
docker run --rm -it \
    ...
    --volume "rust-registry:/opt/local/cargo/registry" \
    --volume "rust-git:/opt/local/cargo/git" \
    yangby0cryptape/ckb-dev:bionic-rustc1.39.0-riscv20190829 \
    ${COMMANDS}
```
...
[`bionic-rustc1.39.0`]: https://github.com/yangby-cryptape/ckb-dockerfiles/tree/bionic-rustc1.39.0/ubuntu/bionic/build
[`bionic-rustc1.39.0-riscv20190829`]: https://github.com/yangby-cryptape/ckb-dockerfiles/tree/bionic-rustc1.39.0-riscv20190829/ubuntu/bionic/build
